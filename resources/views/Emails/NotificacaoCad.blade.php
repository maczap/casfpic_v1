...
<p><span style="color: #ffffff; font-family: Proxima Nova, _apple_system, Helvetica Neue, Helvetica, Roboto, Arial, sans-serif;"><span style="font-size: 26px;"><strong>Novo Cadastro em nome de {{$nome}}</strong></span></span></p>
</td>
</tr>
</tbody>
</table>
...
<p>&nbsp;</p>
<p style="font-size: 16px;">Boa not&iacute;cia. Entrou mais um cadastro.</p>
<p style="font-size: 16px;">Verifique o pagamento para providenciar a carteirinha.</p>
